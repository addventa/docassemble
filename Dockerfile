...
&& mkdir -p /usr/share/docassemble/webapp \
&& mkdir -p /usr/share/docassemble/cron \
&& mkdir -p /usr/share/docassemble/local3.10 \
&& mkdir -p /usr/share/docassemble/config \
&& mkdir -p /usr/share/docassemble/certs \
